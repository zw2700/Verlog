...
Do not use this for bad strategy, waiting loops, no consensus, or incoherent but
parseable behavior.
...
multi-candidate disagreement. We should use outcome metrics to determine whether
this broad negotiation bucket actually improves decisions.
